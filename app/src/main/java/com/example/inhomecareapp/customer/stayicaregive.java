...
public class stayicaregive extends AppCompatActivity {
    RecyclerView rv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_stayicaregive);
        rv=findViewById(R.id.rv_stayin);
        ...
        ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                for (DataSnapshot userSnapshot: snapshot.getChildren()) {
                    ...
                    Listdata.add(l);                                    }
                adds_adapter = new data_adapter(Listdata, stayicaregive.this,model,1);
